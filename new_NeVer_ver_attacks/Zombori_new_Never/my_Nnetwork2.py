...
def main():
    ...
    verifier = ver.SearchVerification()
    sigma = -3
    omega = pow(2,60)
    n = 20
    omegas = np.zeros((2,n))
    ...
    print(condition[0]) # <-- It will always return true: i.e. these weights successfully evade the verifier since the output of the NN is believed to be always equal to 0
